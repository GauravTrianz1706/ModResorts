...
public class WeatherServlet extends HttpServlet {
  ...
  // Server name discovery should be done via environment variables in containerized environments
  // Use ${SERVER_NAME} environment variable instead
  
  // Removed RMI-based setInitialContextProps() method
  // Replace with REST/gRPC service discovery using Spring Cloud and AWS Cloud Map
  // Service endpoints should be configured via environment variables like ${SERVICE_DISCOVERY_URL}
}
