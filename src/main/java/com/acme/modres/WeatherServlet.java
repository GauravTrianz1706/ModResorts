...
public class WeatherServlet extends HttpServlet {
  ...
  // Removed WebSphere-specific configureEnvDiscovery() method
  // Server environment discovery should be done via environment variables in containerized deployments
  // Use environment variables like: SERVER_NAME, POD_NAME, CONTAINER_NAME
  
  // Removed WebSphere-specific RMI/IIOP InitialContext configuration
  // In containerized environments, use REST APIs or message queues for inter-service communication
  // Service discovery should use AWS Cloud Map, Kubernetes DNS, or similar container-native solutions
}
